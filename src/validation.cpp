...
#if defined(NDEBUG)
# error "Lirabit cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Lirabit Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s TLB additional fees, %d delta bytes\n",
