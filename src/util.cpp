...
const char * const BITCOIN_CONF_FILENAME = "lirabit.conf";
const char * const BITCOIN_PID_FILENAME = "lirabit.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Lirabit";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Lirabit";
#else
    // Unix
    return pathRet / ".lirabit";
#endif
#endif
}
