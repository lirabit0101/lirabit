...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s lirabit-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  lirabit-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded lirabit transaction") + "\n" +
              "  lirabit-tx [options] -create [commands]   " + _("Create hex-encoded lirabit transaction") + "\n" +
              "\n";
