...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.lirabit.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.lirabittools.com", true);
        vSeeds.emplace_back("dnsseed.lirabitpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.lirabittools.com", true);
        vSeeds.emplace_back("seed-b.lirabit.loshan.co.uk", true);
